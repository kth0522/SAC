...
class SAC:
    ...
    def train(self, max_epochs=8000, random_epochs=1000, max_steps=1000, save_freq=10):
        ...
        while epoch < max_epochs:
            ...
            next_state, reward, done, _ = self.env.step(np.clip(action[0], self.env.action_space.low, self.env.action_space.high))  # act on env
...
if __name__ == "__main__":
    ...
    sac.train(max_epochs=200000, random_epochs=10000, save_freq=10)
    # reward = sac.test()
    # print(reward)
